...
const AddNotes = () => {
    ...
    const onChange=(e)=>{
        setNote({...note, [e.target.name]:e.target.value}) //...note means the values inside note object  should stay but whatever properties are being passed, add or overwrite them.
    }
    return (
        <div>
            <h2>Add a Note</h2>
